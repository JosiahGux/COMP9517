...
DETECT_RUN_DIR = os.path.join("../../../DL/result/runs", DETECT_RUN_NAME)
DET_BEST_WEIGHTS = os.path.join(DETECT_RUN_DIR, "weights", "best.pt")
CLS_BEST_WEIGHTS = os.path.join("../../../DL/result/runs", "classifier", "best.pth")

# 创建输出目录
os.makedirs("../../../DL/result/runs", exist_ok=True)
